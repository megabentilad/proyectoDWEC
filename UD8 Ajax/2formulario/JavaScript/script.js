...
function mostrarAsignaturasA(){
    ...
    $.post("asignaturas.php",{algo:1}, function(respuesta){
            $(JSON.parse(respuesta)).each(function(){
                    if(cicloA.value !== "nada" && cursoA.value !== "nada"){
                    if(cicloA.value === "DAW"){
                        if(cursoA.value === "primeroA"){
                            for(var i = 0; i < this['asignaturasDAW1A1'].length; i++){
                                opcion = document.createElement("input");
                                opcion.setAttribute("type","checkbox");
                                opcion.setAttribute("name","DAW1A[" + this['asignaturasDAW1A2'][i] + "]");
                                opcion.setAttribute("id","DAW1A[" + this['asignaturasDAW1A2'][i] + "]");
                                opcion.setAttribute("class","CBDAW1");
                                divAsignaturas.appendChild(opcion);

                                etiqueta = document.createElement("label");
                                etiqueta.setAttribute("for","DAW1A[" + this['asignaturasDAW1A2'][i] + "]");

                                texto = document.createTextNode(this['asignaturasDAW1A1'][i]);
                            ...
                            for(var i = 0; i < this['asignaturasDAW2A1'].length; i++){
                                opcion = document.createElement("input");
                                opcion.setAttribute("type","checkbox");
                                opcion.setAttribute("name","DAW1A[" + this['asignaturasDAW2A2'][i] + "]");
                                opcion.setAttribute("id","DAW1A[" + this['asignaturasDAW2A2'][i] + "]");
                                opcion.setAttribute("class","CBDAW1");
                                divAsignaturas.appendChild(opcion);

                                etiqueta = document.createElement("label");
                                etiqueta.setAttribute("for","DAW1A[" + this['asignaturasDAW2A2'][i] + "]");

                                texto = document.createTextNode(this['asignaturasDAW2A1'][i]);
                                etiqueta.appendChild(texto);
                        ...
                        if(cursoA.value === "primeroA"){
                            for(var i = 0; i < this['asignaturasSMR1A1'].length; i++){
                                opcion = document.createElement("input");
                                opcion.setAttribute("type","checkbox");
                                opcion.setAttribute("name","DAW1A[" + this['asignaturasSMR1A2'][i] + "]");
                                opcion.setAttribute("id","DAW1A[" + this['asignaturasSMR1A2'][i] + "]");
                                opcion.setAttribute("class","CBDAW1");
                                divAsignaturas.appendChild(opcion);

                                etiqueta = document.createElement("label");
                                etiqueta.setAttribute("for","DAW1A[" + this['asignaturasSMR1A2'][i] + "]");

                                texto = document.createTextNode(this['asignaturasSMR1A1'][i]);
                                etiqueta.appendChild(texto);
                            ...
                            for(var i = 0; i < this['asignaturasSMR2A1'].length; i++){
                                opcion = document.createElement("input");
                                opcion.setAttribute("type","checkbox");
                                opcion.setAttribute("name","DAW1A[" + this['asignaturasSMR2A2'][i] + "]");
                                opcion.setAttribute("id","DAW1A[" + this['asignaturasSMR2A2'][i] + "]");
                                opcion.setAttribute("class","CBDAW1");
                                divAsignaturas.appendChild(opcion);

                                etiqueta = document.createElement("label");
                                etiqueta.setAttribute("for","DAW1A[" + this['asignaturasSMR2A2'][i] + "]");

                                texto = document.createTextNode(this['asignaturasSMR2A1'][i]);
                                etiqueta.appendChild(texto);
                ...
                if(cicloP.value === "DAW"){
                    if(cursoP.value === "primeroP"){
                        for(var i = 0; i < this['asignaturasDAW1A1'].length; i++){
                            ...
                            option.setAttribute("value", this['asignaturasDAW1A2'][i]);
                        ...
                        for(var i = 0; i < this['asignaturasDAW2A1'].length; i++){
                            option = document.createElement("option");
                            option.setAttribute("value", this['asignaturasDAW2A2'][i]);
                    ...
                    if(cursoP.value === "primeroP"){
                        for(var i = 0; i < this['asignaturasSMR1A1'].length; i++){
                            option = document.createElement("option");
                            option.setAttribute("value", this['asignaturasSMR1A2'][i]);
                        ...
                        for(var i = 0; i < this['asignaturasSMR2A1'].length; i++){
                            option = document.createElement("option");
                            option.setAttribute("value", this['asignaturasSMR2A2'][i]);
