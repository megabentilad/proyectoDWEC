...
function validarRadioB (nombre){
    if(document.formulario.elements[nombre].selected){
        return true;
    }
    return false;
}

function validarCBox (nombre, cuantos){
    if(document.formulario.elements[nombre].length >= cuantos){
        return true;
    }
    return false;
}